...
export const siteConfig: SiteConfig = {
  ...
  name: "Vantek AI",
  description:
    "Vantek AI & Vantek Engine",
  author: "Vantek AI",
  email: "vantek-ai@vantek-ai.com",
  ...
  socialLinks: [
    ...
    {
      platform: "linkedin",
      url: "https://www.linkedin.com/in/vantek-ai/",
      label: "LinkedIn",
    },
    { platform: "email", url: "mailto:vantek-ai@vantek-ai.com", label: "Email" },
  ],
